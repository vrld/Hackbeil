module.exports = {
  ...
  body: p => {
    ...
    const silk = (layer, justify) => [
      `(fp_poly ${coordinates} (layer ${layer}) (stroke (width .25) (type solid)) (fill none))`,
      ...
      `(fp_text user "Trackpoint Joystick rev 2" (at 0 7 0) (layer ${layer}) (effects (font (size .8 .8) (thickness .15)) ${justify}))`,
    ].join('')
