...
module.exports = {
  ...
  (footprint "ceoloide:display_nice_view"
    ...
    (fp_text user "DA" (at -5.08 ${13.1 + labels_offset} ${p.r - 90}) (layer "F.SilkS")
      (effects (font (size 1 1) (thickness 0.15)))
    )
    (fp_text user "CS" (at 5.12 ${13.1 + labels_offset} ${p.r - 90}) (layer "F.SilkS")
      (effects (font (size 1 1) (thickness 0.15)))
    )
    (fp_text user "GND" (at 2.62 ${13.1 + labels_offset} ${p.r - 90}) (layer "F.SilkS")
      (effects (font (size 1 1) (thickness 0.15)))
    )
    (fp_text user "VCC" (at 0.15 ${13.1 + labels_offset} ${p.r - 90}) (layer "F.SilkS")
      (effects (font (size 1 1) (thickness 0.15)))
    )
    (fp_text user "CL" (at -2.48 ${13.1 + labels_offset} ${p.r - 90}) (layer "F.SilkS")
      (effects (font (size 1 1) (thickness 0.15)))
    )
    `

    const silkscreen_labels_back = `
    (fp_text user "CS" (at -4.98 ${13.1 + labels_offset} ${p.r - 90}) (layer "B.SilkS")
      (effects (font (size 1 1) (thickness 0.15)) (justify mirror))
    )
    (fp_text user "VCC" (at 0.15 ${13.1 + labels_offset} ${p.r - 90}) (layer "B.SilkS")
      (effects (font (size 1 1) (thickness 0.15)) (justify mirror))
    )
    (fp_text user "DA" (at 5.22 ${13.1 + labels_offset} ${p.r - 90}) (layer "B.SilkS")
      (effects (font (size 1 1) (thickness 0.15)) (justify mirror))
    )
    (fp_text user "CL" (at 2.72 ${13.1 + labels_offset} ${p.r - 90}) (layer "B.SilkS")
      (effects (font (size 1 1) (thickness 0.15)) (justify mirror))
    )
    (fp_text user "GND" (at -2.38 ${13.1 + labels_offset} ${p.r - 90}) (layer "B.SilkS")
      (effects (font (size 1 1) (thickness 0.15)) (justify mirror))
    )
    `
