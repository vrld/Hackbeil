module.exports = {
    ...
    body: p => {
        ...
        const standard = `
            (module E73:SPDT_C128955 (layer F.Cu)
        ...
        function pads(side, left, right) {
            return `
                ${'' /* outline */}
                (fp_line (start -3.1 -1.35) (end 3.1 -1.35) (layer ${side}.SilkS) (width 0.15))
                (fp_line (start -3.3 -.5) (end -3.3 .5) (layer ${side}.SilkS) (width 0.15))
                (fp_line (start 3.3 -.5) (end 3.3 .5) (layer ${side}.SilkS) (width 0.15))
