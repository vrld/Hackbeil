...
module.exports = {
  ...
  ${''/* Controller outline */}
    ...
    const instructions = `
    (fp_text user "R Jumpers, MCU ${!p.reverse_mount ? 'Up' : 'Down'}" (at 0 17.245 ${p.r}) (layer "F.SilkS")
      (effects (font (size .8 .8) (thickness 0.1)))
    )
    (fp_text user "L Jumpers, MCU ${!p.reverse_mount ? 'Up' : 'Down'}" (at 0 17.245 ${p.r}) (layer "B.SilkS")
      (effects (font (size .8 .8) (thickness 0.1)) (justify mirror))
    )
    `
